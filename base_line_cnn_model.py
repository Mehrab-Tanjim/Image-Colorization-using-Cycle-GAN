...
class EDcoder_cnn(nn.Module):

    def __init__(self):
        super(EDcoder_cnn, self).__init__()
...
#         h += pool1
        ...
        h = self.deconv10(h)
        h = F.tanh(h) # 2,224,224 ## may be useless 
